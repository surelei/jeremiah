...
import com.jeremiahxu.leisure.po.UserBuilder;
...
public class UserServiceImplTest extends AbstractTransactionalJUnit4SpringContextTests {
	...
	public void createUserAndLoadByName() {
		...
		UserProfile userComp = userService.findUserByName(name);
	...
	public void createUserThenLoadByNameAndPass() {
		...
		UserProfile userNone = userService.findUserByNameAndPassword("name1", "nopass");
		UserProfile userComp = userService.findUserByNameAndPassword(name, password);
